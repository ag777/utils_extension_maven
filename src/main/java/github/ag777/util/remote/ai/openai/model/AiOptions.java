 ...
 */
public class AiOptions extends HashMap<String, Object> {
     ...
     */
    public AiOptions seed(int seed) {
        put("seed", seed);
        return this;
    }
     ...
     */
    public AiOptions numKeep(int numKeep) {
     ...
     */
    public AiOptions numPredict(int numPredict) {
     ...
     */
    public AiOptions topK(int topK) {
        put("top_k", topK);
        return this;
    }
     ...
     */
    public AiOptions topP(double topP) {
        put("top_p", topP);
        return this;
    }
     ...
     * - 较大值(0.1-0.2)使输出更保守
     */
    public AiOptions minP(double minP) {
        put("min_p", minP);
        return this;
    }
     ...
     * - 1.0-2.0: 更保守的输出
     */
    public AiOptions tfsZ(double tfsZ) {
        put("tfs_z", tfsZ);
        return this;
    }
     ...
     * - 0.8-1.0: 更多样化
     */
    public AiOptions typicalP(double typicalP) {
     ...
     */
    public AiOptions repeatLastN(int repeatLastN) {
     ...
     * - >1.0: 高度随机，不建议使用
     */
    public AiOptions temperature(double temperature) {
     ...
     * - 1.3-1.5: 强烈避免重复
     */
    public AiOptions repeatPenalty(double repeatPenalty) {
     ...
     * - 1.0-2.0: 强烈鼓励新内容
     */
    public AiOptions presencePenalty(double presencePenalty) {
     ...
     * - 1.0-2.0: 强烈降低常见词使用
     */
    public AiOptions frequencyPenalty(double frequencyPenalty) {
     ...
     */
    public AiOptions mirostat(int mirostat) {
     ...
     * - 5.0-6.0: 更多样化输出
     */
    public AiOptions mirostatTau(double mirostatTau) {
     ...
     * - 0.2-0.3: 快速适应但可能不稳定
     */
    public AiOptions mirostatEta(double mirostatEta) {
     ...
     */
    public AiOptions penalizeNewline(boolean penalizeNewline) {
     ...
     */
    public AiOptions stop(String[] stop) {
        put("stop", stop);
        return this;
    }
     ...
     */
    public AiOptions numa(boolean numa) {
        put("numa", numa);
        return this;
    }
     ...
     */
    public AiOptions numCtx(int numCtx) {
        put("num_ctx", numCtx);
        return this;
    }
     ...
     */
    public AiOptions numBatch(int numBatch) {
     ...
     */
    public AiOptions numGpu(int numGpu) {
        put("num_gpu", numGpu);
        return this;
    }
     ...
     * 建议：多GPU系统中指定主要计算设备
     */
    public AiOptions mainGpu(int mainGpu) {
     ...
     * 建议：显存不足时启用，会牺牲一些性能
     */
    public AiOptions lowVram(boolean lowVram) {
     ...
     */
    public AiOptions vocabOnly(boolean vocabOnly) {
     ...
     */
    public AiOptions useMmap(boolean useMmap) {
     ...
     */
    public AiOptions useMlock(boolean useMlock) {
     ...
     * - 考虑实际负载和其他应用程序需求
     */
    public AiOptions numThread(int numThread) {
     ...
     * - 强力的重复控制
     */
    public static AiOptions ofCoding() {
        return new AiOptions()
     ...
     * - 较弱的重复控制
     */
    public static AiOptions ofCreativeWriting() {
        return new AiOptions()
     ...
     * - 中等重复控制
     */
    public static AiOptions ofChat() {
        return new AiOptions()
     ...
     * - 强力的重复控制
     */
    public static AiOptions ofSummarization() {
        return new AiOptions()
     ...
     * - 较小的批处理大小
     */
    public static AiOptions ofLowResource() {
        return new AiOptions()
