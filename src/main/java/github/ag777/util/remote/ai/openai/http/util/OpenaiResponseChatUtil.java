 ...
 */
public class OpenaiResponseChatUtil extends ResponseBaseUtil {
     ...
     */
    public String getMessage() throws GsonSyntaxException {
        /*
        ...
        JsonObject message = JsonObjectUtils.getJsonObject(choices.get(0).getAsJsonObject(), "message");
        if (message == null) {
            return "";
        }
        return JsonObjectUtils.getStr(message, "content", "");
    }
