...
import github.ag777.util.remote.ai.okhttp.ollama.model.request.*;
import github.ag777.util.remote.ai.okhttp.ollama.model.response.OllamaResponsePs;
import github.ag777.util.remote.ai.okhttp.ollama.model.response.OllamaResponseTags;
import github.ag777.util.remote.ai.okhttp.ollama.util.response.OllamaResponseChatUtil;
import github.ag777.util.remote.ai.okhttp.ollama.util.response.OllamaResponseEmbedUtil;
import github.ag777.util.remote.ai.okhttp.ollama.util.response.OllamaResponseGenerateUtil;
